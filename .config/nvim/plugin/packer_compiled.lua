...
_G.packer_plugins = {
  ["AnsiEsc.vim"] = {
    loaded = true,
    path = "/home/patrick/.local/share/nvim/site/pack/packer/start/AnsiEsc.vim",
    url = "https://github.com/vim-scripts/AnsiEsc.vim"
  },
  bbpr = {
    loaded = true,
    path = "/home/patrick/.local/share/nvim/site/pack/packer/start/bbpr",
    url = "/run/media/patrick/lap_data/Documents/bbpr"
  },
  ["cellular-automaton.nvim"] = {
    loaded = true,
    path = "/home/patrick/.local/share/nvim/site/pack/packer/start/cellular-automaton.nvim",
  ...
  ["tabnine-nvim"] = {
    loaded = true,
    path = "/home/patrick/.local/share/nvim/site/pack/packer/start/tabnine-nvim",
  ...
  undotree = {
    loaded = true,
    path = "/home/patrick/.local/share/nvim/site/pack/packer/start/undotree",
